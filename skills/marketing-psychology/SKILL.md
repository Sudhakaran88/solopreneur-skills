...
description: When the user wants to apply psychological principles, mental models, or behavioral science to marketing. Also trigger on "psychology", "mental models", "cognitive bias", "persuasion", "behavioral science", "why people buy", "decision-making", "consumer behavior", "Cialdini", "social proof", "scarcity", "FOMO", "anchoring". Covers 20+ principles organized for direct marketing application.
metadata:
  version: 1.0.0
  author: Sudhakar
  license: MIT
...
| **Effort** | Zero conscious effort | High cognitive load |
| **Drives** | Emotion, habit, pattern recognition | Logic, analysis, comparison |
| **Influenced by** | Visuals, stories, social proof, gut feel | Features, specs, ROI, data |
...
| Type | What it signals | Best placement |
|---|---|---|
| **Wisdom of crowds** | "Many people chose this" | Signup CTAs, pricing pages ("Join 12,000 users") |
| **Expert authority** | "Trusted professionals endorse this" | Hero sections, media logos, certifications |
| **User / peer proof** | "Someone like me had success" | Below the fold, near objections, checkout |
...
| Real scarcity/urgency | Fake scarcity/urgency |
|---|---|
| Cohort closes Friday with no re-open date | Countdown timer that resets on refresh |
| Only 3 seats left (actually 3) | "Only 5 left!" on unlimited digital product |
| Price increases at end of launch window (it does) | Perpetual "48-hour sale" |
| Beta closes when capacity hits | "Limited time" with no actual end |
...
| Pillar | How to demonstrate it |
|---|---|
| **Experience** | Specific results you've achieved yourself ("I grew from 0 to 8,000 subscribers using this") |
| **Expertise** | Credentials, depth of knowledge, proprietary frameworks and names |
| **Authoritativeness** | Third-party recognition (press, podcasts, speaking, being cited) |
| **Trustworthiness** | Transparency, consistency, acknowledging what you don't know |
...
|---|---|---|
| Basic | $29/month | Real option for budget buyers |
| **Pro (target)** | **$79/month** | **The one you want most people to choose** |
| Enterprise | $149/month | Decoy — makes Pro feel like a steal |
...
- **Problem section:** Loss framing — name the pain they're living with
- **Solution section:** Authority + reciprocity — show methodology, give a quick win
- **Social proof:** Specific peer testimonials near the CTA, media logos in the header
- **CTA:** Single action, loss-framed or benefit-framed, not feature-framed

### Pricing Page
- **Lead with value anchor** before showing price ("Everything you need to..." before the number)
- **3 tiers max** with one recommended (Paradox of Choice + Decoy Effect)
- **Show the most premium tier first** on desktop (anchoring)
- **Annual toggle default** — pre-select annual, not monthly
- **Near buy button:** Most specific, outcome-focused testimonial you have
- **Loss-frame the free tier limit:** "You're missing X on the free plan"

### Email
- **Subject line:** System 1 — curiosity, loss framing, or social proof pattern interrupt
- **Single CTA** — one link, one action
- **Reciprocity before pitch** — lead with a useful insight or resource
- **Commitment ladder:** Match CTA complexity to relationship stage (cold → low-friction ask)
- **Peak-End:** End every email with value, not just a sell

### Checkout
- **Reduce choice** — strip the page of navigation and distractions
- **Social proof** at the last moment of doubt — "X people purchased this week"
- **Loss aversion** reminder — reinforce what they're about to access, not just what they're paying
- **Anchoring** — show the full value of what's included one final time
- **Scarcity only if real** — if the offer has a real deadline, surface it here

---

## Common Mistakes

**1. Using fake scarcity**
40% of countdown timers online are fake. 60%+ of buyers test by refreshing. The trust damage is permanent and extends to all future offers. Real scarcity only — or no scarcity at all.

**2. Generic social proof**
"Great product, 5 stars!" is nearly worthless. "I closed 3 clients in my first week" is powerful. Audit and replace every vague testimonial with a specific outcome.

**3. Applying loss framing to cold audiences**
Loss framing works when buyers already understand the value of what they might lose. With cold traffic, lead with reciprocity and social proof first. Save loss framing for warm leads and upgrade flows.

**4. Too many CTAs on one page**
Every additional CTA option reduces the conversion rate of each. Pick one primary action per page and architect everything else to support it.

**5. Anchoring by accident**
Your first price shown, your first feature mentioned, your hero image — all anchor perception. If you're not deliberate about anchors, you're anchoring to the wrong things.

**6. Treating dark patterns as "just marketing"**
Fake urgency, hidden fees revealed at checkout, pre-checked upsells, impossible-to-find cancellation — these are increasingly illegal (FTC, EU Digital Services Act) and reliably destroy LTV. The short-term conversion lift is real; the long-term cost is larger.

**7. Overwhelming with options**
The jam study is not theoretical. Three pricing tiers. One recommended. One CTA. If your instinct is to add more, the right move is almost always to cut.

---

## Contrarian Takes

**"Social proof at scale is losing its edge."**
As testimonials and star ratings become universal, they're becoming invisible. What cuts through now: specificity, video, peer-identity match ("I'm a freelance designer who..." rather than generic), and unusual honesty ("It took me 6 weeks before it clicked, but then...").

**"Loss aversion is overused in SaaS upgrade flows."**
Constant "you're missing out" messaging in product UX creates anxiety and erodes trust. Reserve loss framing for genuine moments of high stakes. If you trigger it for every micro-upsell, buyers become immune and start to resent the product.

**"The decoy effect only works if your tiers tell a coherent story."**
Random pricing tiers with confusing feature ladders don't trigger the decoy effect — they trigger confusion. The psychological mechanism only activates when the comparison is easy to process. Clarity first, psychology second.

**"Reciprocity creates the wrong buyers if you over-give for free."**
When buyers get too much value for free, some conclude they don't need to pay. Your free content should solve a real problem — and create a clear awareness of the larger problem they still have. The goal is progress, not completion.

---

## Related Skills

- **copywriting** — Applying these principles to specific copy formats (headlines, CTAs, email, landing pages)
- **pricing-strategy** — Decoy effect, anchoring, and tier design in depth
- **page-cro** — Full conversion optimization workflows for landing pages
- **email-sequence** — Loss aversion, reciprocity, and commitment ladders across email flows
- **paywall-upgrade-cro** — Upgrade prompts, loss framing, and progression psychology for SaaS

---

*Generated using the marketing-psychology skill from Solopreneur Skills*
